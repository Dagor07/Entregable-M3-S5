      ...
      <div class="card mx-auto shadow p-4" style="max-width: 600px;">
        ...
        <form id="create-event-form">
          <div class="mb-3">
            ...
            <input type="text" id="name" class="form-control" placeholder="Ej. Feria tecnológica" required />
          </div>
          <div class="mb-3">
            <label for="description" class="form-label">Descripción</label>
            <textarea id="description" class="form-control" placeholder="Descripción del evento" required></textarea>
          </div>
          <div class="mb-3">
  ...
  document.getElementById('create-event-form').addEventListener('submit', async (e) => {
    ...
    try {
      if (!newEvent.name || !newEvent.description || !newEvent.date || isNaN(newEvent.capacity)) {
        alertBox.textContent = 'Todos los campos son obligatorios y deben ser válidos.';
